...
# Importa as funções de gerenciamento de ingredientes, pratos e pedido de pratos
from ingredientes import gerenciar_ingredientes
from pratos import gerenciar_pratos
from pedir_pratos import pedir_pratos  # Nova funcionalidade adicionada
...
def login():
    def autenticar():
        ...
        try:
            ...
            if usuario:
                ...
                root.destroy()
                abrir_menu()  # Abre o menu principal
            else:
    ...
    def registrar():
        ...
        btn_criar_usuario = tk.Button(
            registrar_window, text="Registrar", command=criar_usuario
        )
